...
int main()
{
    ...
    if(bas1==0 && bas2>bas3){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o2);
    }else if(bas1==0 && bas3>bas2){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o4);
    }else if(bas2==0 && bas1>bas3){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o1);
    }else if(bas2==0 && bas3>bas1){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o5);
    }else if(bas1>bas2 && bas2 > bas3 && bas1!=0 && bas2!=0 && bas3!=0){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o1);
    }else if(bas1>bas3 && bas3>bas2 && bas1!=0 && bas2!=0 && bas3!=0){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o3);
    }else if(bas2>bas1 && bas1>bas3 && bas1!=0 && bas2!=0 && bas3!=0){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o2);
    }else if(bas2>bas3 && bas3>bas1 && bas1!=0 && bas2!=0 && bas3!=0){
        printf("bu sayidan elde edilebilecek en kucuk sayi=%d",o6);
